...
<head>
    ...
    <title>Confirmação de Afiliado</title>
    <style>
...
<body>
    ...
    <div class="confirmation-container">
        <h1 class="confirmation-title">Afiliado Criado com Sucesso!</h1>
        <p class="confirmation-message">Parabéns, você foi aprovado como afiliado! Seu cupom de desconto é: <strong>${affiliateCoupon}</strong></p>
